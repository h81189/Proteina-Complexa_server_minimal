...
from atomworks.ml.transforms.atom_frames import AddAtomFrames, AddIsRealAtom, AddPolymerFrameIndices
...
from proteinfoundation.datasets.atomworks_transforms import AggregateFeaturesLikeAF3NoMSA
...
def build_af3_transform_pipeline(
    *,
    ...
    # MSA dirs
    protein_msa_dirs: list[dict] = None,
    rna_msa_dirs: list[dict] = None,
    # Recycles
    n_recycles: int = 5,
    # Crop params
    crop_size: int = 384,
    ...
    **kwargs,
    ...
    if protein_msa_dirs or rna_msa_dirs:
        transforms += [
            # ... load and pair MSAs
            LoadPolymerMSAs(
    ...
    if not protein_msa_dirs and not rna_msa_dirs:
        transforms += [AggregateFeaturesLikeAF3NoMSA()]
    else:
        transforms += [AggregateFeaturesLikeAF3()]
