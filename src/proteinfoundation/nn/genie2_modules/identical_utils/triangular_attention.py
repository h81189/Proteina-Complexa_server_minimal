...
from proteinfoundation.nn.genie2_modules.identical_utils.primitives import Attention, Linear
from proteinfoundation.nn.genie2_modules.identical_utils.tensor_utils import chunk_layer, permute_final_dims


class TriangleAttention(nn.Module):
    def __init__(self, c_in, c_hidden, no_heads, starting, chunk_size=4, inf=1e9):
        """
        Args:
            c_in:
    ...
    def forward(self, x, mask=None):
        ...
        # [*, I, H, I, J]
        i = x.shape[-3]
        triangle_bias = triangle_bias.expand((*((-1,) * len(triangle_bias.shape[:-4])), i, -1, -1, -1))
