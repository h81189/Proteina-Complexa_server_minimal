...
from proteinfoundation.nn.genie2_modules.identical_utils.primitives import Linear
from proteinfoundation.nn.genie2_modules.identical_utils.tensor_utils import permute_final_dims
