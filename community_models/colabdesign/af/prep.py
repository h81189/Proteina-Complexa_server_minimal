  ...
  def _prep_binder(self, pdb_filename,
    ...
    if redesign:
      ...
      self.opt["weights"].update({"dgram_cce":1.0, "rmsd":0.0, "fape":0.0,
                                  "con":0.0, "i_con":0.0, "i_pae":0.0, "min_ipae":0.0, "min_ipsae":0.0, "avg_ipsae":0.0, "max_ipsae":0.0,
                                  "min_ipsae_10":0.0, "max_ipsae_10":0.0, "avg_ipsae_10":0.0,
                                  "alignment_bb_ca":0.0, "alignment_bb_ca_binder":0.0, "helix_binder":0.0, "rg":0.0, "nc_termini":0.0, "i_ptm":0.0, "i_ptm_energy":0.0
                                  })
    else:
