...
class design_model:
  ...
  def set_seq(self, seq=None, mode=None, bias=None, rm_aa=None, set_state=True, struct=None, **kwargs):
    '''
  ...
  def set_seed(self, seed=None):
    ...
    self.key = Key(seed=seed, device=self._device if hasattr(self, "_device") else None).get
